...
const ACTIVITIES: { id: SidebarView; label: string; icon: string }[] = [
  ...
  },
  {
    id: "projects",
    label: "Projects",
    icon: `<svg viewBox="0 0 24 24"><circle cx="7" cy="7" r="2.6" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="17" cy="7" r="2.6" fill="none" stroke="currentColor" stroke-width="1.5"/><circle cx="12" cy="17" r="2.6" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M8.8 8.8 11 14.4M15.2 8.8 13 14.4" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`,
  },
  {
    id: "agents",
    label: "Manage Agents",
