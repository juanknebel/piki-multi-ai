...
const OBSIDIAN_DARK: ThemePreset = {
  ...
  colors: {
    ...
    "text-primary": "#adbac7", "text-secondary": "#768390", "text-muted": "#3d4957",
    ...
    "activity-bar-inactive": "#4d5768", "activity-bar-badge": "#39bae6",
...
const NORD_DARK: ThemePreset = {
  ...
  colors: {
    ...
    "activity-bar-inactive": "#616e88", "activity-bar-badge": "#88c0d0",
    "sidebar-bg": "#2e3440", "sidebar-header-bg": "#2e3440", "sidebar-header-fg": "#81a1c1",
    "sidebar-item-hover": "#3b4252", "sidebar-item-active": "#434c5e",
    "tab-active-bg": "#2e3440", "tab-active-fg": "#eceff4", "tab-inactive-bg": "#3b4252",
    "tab-inactive-fg": "#81a1c1", "tab-border": "#3b4252", "tab-active-border-top": "#88c0d0",
    ...
    "git-modified": "#ebcb8b", "git-added": "#a3be8c", "git-deleted": "#bf616a",
...
const CATPPUCCIN_MOCHA: ThemePreset = {
  ...
  colors: {
    ...
    "activity-bar-inactive": "#6c7086", "activity-bar-badge": "#89b4fa",
...
const SOLARIZED_LIGHT: ThemePreset = {
  ...
  colors: {
    ...
    "text-primary": "#586e75", "text-secondary": "#93a1a1", "text-muted": "#c0c4bb",
    "text-accent": "#268bd2", "text-bright": "#073642",
    "border-primary": "#ddd6c1", "border-active": "#268bd2", "border-inactive": "#ddd6c1",
    "accent-primary": "#268bd2", "accent-hover": "#2aa198", "accent-focus": "#268bd2",
    "accent-warm": "#b58900",
    "activity-bar-bg": "#eee8d5", "activity-bar-fg": "#073642",
    "activity-bar-inactive": "#93a1a1", "activity-bar-badge": "#268bd2",
    "sidebar-bg": "#fdf6e3", "sidebar-header-bg": "#eee8d5", "sidebar-header-fg": "#93a1a1",
    "sidebar-item-hover": "#eee8d5", "sidebar-item-active": "#ddd6c1",
    "tab-active-bg": "#fdf6e3", "tab-active-fg": "#073642", "tab-inactive-bg": "#eee8d5",
    "tab-inactive-fg": "#93a1a1", "tab-border": "#ddd6c1", "tab-active-border-top": "#268bd2",
    "terminal-bg": "#fdf6e3", "terminal-fg": "#586e75", "terminal-cursor": "#268bd2",
    "statusbar-bg": "#eee8d5", "statusbar-fg": "#586e75", "statusbar-no-folder": "#6c71c4",
    "git-modified": "#b58900", "git-added": "#859900", "git-deleted": "#dc322f",
    "git-renamed": "#859900", "git-untracked": "#2aa198", "git-conflicted": "#cb4b16",
    "git-staged": "#859900", "git-staged-modified": "#b58900",
...
const TOKYO_NIGHT: ThemePreset = {
  ...
  colors: {
    ...
    "activity-bar-inactive": "#565f89", "activity-bar-badge": "#7aa2f7",
    "sidebar-bg": "#1a1b26", "sidebar-header-bg": "#16161e", "sidebar-header-fg": "#565f89",
    "sidebar-item-hover": "#24283b", "sidebar-item-active": "#292e42",
    "tab-active-bg": "#1a1b26", "tab-active-fg": "#c0caf5", "tab-inactive-bg": "#16161e",
    "tab-inactive-fg": "#565f89", "tab-border": "#24283b", "tab-active-border-top": "#7aa2f7",
