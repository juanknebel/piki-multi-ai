...
impl Context {
    ...
    pub fn title(self) -> &'static str {
        match self {
            ...
            Context::ProjectSearch => "Project content search",
    ...
    pub fn opened_by(self) -> Option<&'static str> {
        match self {
            ...
            Context::ProjectSearch => Some("project_search"),
...
static CATALOG: &[ActionMeta] = {
    &[
        ...
        app("restart_tab", "Tabs", "Restart Tab", "restart"),
        app("move_tab", "Tabs", "Move Tab to Workspace", "move"),
        app("fuzzy_search", "Search", "Fuzzy File Search", "find file"),
        app(
            "project_search",
            "Search",
            "Search in Project (content)",
            "grep",
        ),
        ...
        local(C::ProjectSearch, Fixed("Type"), "Edit the search text"),
        local(
            C::ProjectSearch,
            Bind("fuzzy", "down"),
        ...
        local(C::ProjectSearch, Bind("fuzzy", "exit"), "Close"),
        // ── Command palette ───────────────────────────────────────────────
